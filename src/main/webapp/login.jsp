						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form class="user" action="${pageContext.request.contextPath}/LoginControllerServlet" method="post">

										<div class="form-group">
											<input type="email" class="form-control form-control-user" id="login" aria-describedby="login"
												placeholder="Informe seu login" name="login">
										</div>

										<div class="form-group">
											<input type="password" class="form-control form-control-user" id="senha" placeholder="Informe sua senha" name="senha">
										</div>

										<c:if test="${not empty loginErro}">
											<div class="alert alert-danger" role="alert">${loginErro}</div>
										</c:if>
